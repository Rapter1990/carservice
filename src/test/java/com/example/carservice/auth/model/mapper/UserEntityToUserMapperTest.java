...
class UserEntityToUserMapperTest {
    ...
    void testMapSingleUserEntity() {
        ...
        assertEquals(userEntity.getCreatedBy(), result.getCreatedUser());
        assertEquals(userEntity.getUpdatedAt(), result.getUpdatedAt());
        assertEquals(userEntity.getUpdatedBy(), result.getUpdatedUser());
    ...
    void testMapWithEdgeCaseValues() {
        ...
        assertNull(result.getCreatedUser());
        assertNull(result.getUpdatedAt());
        assertNull(result.getUpdatedUser());
